Public Class HighPrice
    ...
    Private Sub HighPrice_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '/////////////////////////////////////////////////////////////////////////////////////
        '//
    ...
    Public Function ListPreparation()
        ...
        MySQLstr = "SELECT CONVERT(nvarchar(50),tbl_CRM_HighPrice.ID) AS ID, tbl_CRM_HighPrice.ScalaCode, "
        MySQLstr = MySQLstr & "ISNULL(tbl_CRM_HighPrice.SupplierCode, tbl_CRM_HighPrice.OtherSupplierCode) AS SupplierCode, "
        MySQLstr = MySQLstr & "CASE WHEN SC010300.SC01001 IS NULL THEN tbl_CRM_HighPrice.OtherItem ELSE Ltrim(Rtrim(Ltrim(Rtrim(ISNULL(SC010300.SC01002, ''))) + ' ' + Ltrim(Rtrim(ISNULL(SC010300.SC01002, ''))))) END AS ItemName, "
        MySQLstr = MySQLstr & "tbl_CRM_HighPrice.ScalaSupplierCode, "
        MySQLstr = MySQLstr & "CASE WHEN PL010300.PL01001 IS NULL THEN tbl_CRM_HighPrice.OtherSupplier ELSE Ltrim(Rtrim(ISNULL(PL010300.PL01002, ''))) END AS ScalaSupplierName, "
        MySQLstr = MySQLstr & "tbl_CRM_HighPrice.OurPriCost, "
        MySQLstr = MySQLstr & "tbl_CRM_HighPrice.OurPrice, "
        MySQLstr = MySQLstr & "tbl_CRM_HighPrice.EstimatedPrice "
        MySQLstr = MySQLstr & "FROM tbl_CRM_HighPrice WITH(NOLOCK) LEFT OUTER JOIN "
        MySQLstr = MySQLstr & "PL010300 ON tbl_CRM_HighPrice.ScalaSupplierCode = PL010300.PL01001 LEFT OUTER JOIN "
        MySQLstr = MySQLstr & "SC010300 ON tbl_CRM_HighPrice.ScalaCode = SC010300.SC01001 "
        MySQLstr = MySQLstr & "WHERE (tbl_CRM_HighPrice.EventID = '" & Declarations.MyEventID & "') "
        MySQLstr = MySQLstr & "ORDER BY tbl_CRM_HighPrice.ScalaCode, ISNULL(tbl_CRM_HighPrice.SupplierCode, tbl_CRM_HighPrice.OtherSupplierCode) "
        ...
        DataGridView2.Columns(1).HeaderText = "Код Scala"
        DataGridView2.Columns(1).Width = 120
        DataGridView2.Columns(2).HeaderText = "Код товара поставщика"
        DataGridView2.Columns(2).Width = 120
        DataGridView2.Columns(3).HeaderText = "Имя продукта"
        DataGridView2.Columns(3).Width = 280
        DataGridView2.Columns(4).HeaderText = "Код поставщика"
        DataGridView2.Columns(4).Width = 130
        DataGridView2.Columns(5).HeaderText = "Поставщик"
        DataGridView2.Columns(5).Width = 200
        DataGridView2.Columns(6).HeaderText = "Наша себесто имость"
        DataGridView2.Columns(6).Width = 120
        DataGridView2.Columns(7).HeaderText = "Наша цена"
        DataGridView2.Columns(7).Width = 120
        DataGridView2.Columns(8).HeaderText = "Цена запрошенная клиентом"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        MySupplierSelect.MySrcWin = "HighPrice"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            MyItemSelectList.MySrcWin = "HighPrice"
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        MyItemHighPrice = New ItemHighPrice
        MyItemHighPrice.ShowDialog()
    End Sub
